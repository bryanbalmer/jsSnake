...
Snake.prototype.tick = function(e) {
	...
	function normalizeX(seg1, seg2) {
		...
		if(seg2.direction === 'up')
			seg1.body.y = seg2.body.y + seg2.size;
		if(seg2.direction === 'down')
			seg1.body.y = seg2.body.y - seg2.size;
	}
	...
	function normalizeY(seg1, seg2) {
		...
		if(seg2.direction === 'left')
			seg1.body.x = seg2.body.x + seg2.size;
		if(seg2.direction === 'right')
			seg1.body.x = seg2.body.x - seg2.size;
	}
};